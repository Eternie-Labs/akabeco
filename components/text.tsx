    ...
    return (
        <div className={className}>
            ...
            <section id="english" lang="en" className={locale === 'en' ? '' : 'hidden'}>
                ...
                <p>
                    The source code of this website is available on <a href="https://github.com/kuropen/akabeco-site">GitHub</a>.<br/>
            ...
            <section id="japanese" lang="ja" className={locale === 'ja' ? '' : 'hidden'}>
                ...
                <p>
                    このサイトのソースコードは<a href="https://github.com/kuropen/akabeco-site">GitHub</a>で公開されています。<br/>
